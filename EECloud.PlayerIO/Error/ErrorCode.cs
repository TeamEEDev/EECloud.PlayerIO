namespace EECloud.PlayerIO
{
    public enum ErrorCode
    {
        ...
        /// <summary>
        /// The index is out of bounds from the range of acceptable values.
        /// </summary>
        IndexOutOfBounds = 81,


        /// <summary>
        /// The game has been disabled, most likely because of a missing payment.
        /// </summary>
        GameDisabled = 9,
        ...
        /// <summary>
        /// There is no server in any of the selected server clusters for the game that is eligible to start a new room (they're all at full capacity or there are no servers in any of the clusters). Either change the selected clusters for your game by using the admin panel, try again later, or start some more servers for one of your clusters.
        /// </summary>
        ...
        /// <summary>
        /// There's no room running with that ID.
        /// </summary>
        UnknownRoom = 17,
        
        /// <summary>
        /// You can't join a room when the RoomID is null or the empty string.
        /// </summary>
        MissingRoomId = 18,
        ...
        /// <summary>
        /// The key you specified is not set as searchable. You can change the searchable keys for this server type by using the admin panel.
        /// </summary>
        NotASearchColumn = 20,
        
        /// <summary>
        /// The QuickConnect method (Simple, Facebook, Kongregate) is not enabled for the game. You can enable the various methods for the game by using the admin panel.
        /// </summary>
        ...
        /// <summary>
        /// The supplied registration data is not correct.
        /// </summary>
        InvalidRegistrationData = 24,
        
        /// <summary>
        /// The key given for the BigDB object is not a valid BigDB key. BigDB keys must be between 1 and 50 characters in length (without spaces).
        /// </summary>
        InvalidBigDBKey = 25,
        ...
        /// <summary>
        /// Couldn't find the BigDB object.
        /// </summary>
        BigDBObjectDoesNotExist = 27,
        
        /// <summary>
        /// The specified table doesn't exists.
        /// </summary>
        UnknownTable = 28,
        
        /// <summary>
        /// The specified index doesn't exists.
        /// </summary>
        UnknownIndex = 29,
        
        /// <summary>
        /// The value given for the index doesn't match the expected type.
        /// </summary>
        InvalidIndexValue = 30,
        
        /// <summary>
        /// The operation has just been aborted because the user attempting the operation was not the original creator of the object accessed.
        /// </summary>
        NotObjectCreator = 31,
        
        /// <summary>
        /// The key is already in use by an other BigDB object.
        /// </summary>
        KeyAlreadyUsed = 32,
        ...
        /// <summary>
        /// Can't create circular references inside BigDB objects.
        /// </summary>
        CircularReference = 34,
        
        /// <summary>
        /// The server couldn't complete the heartbeat.
        /// </summary>
        HeartbeatFailed = 40,
        ...
        /// <summary>
        /// The specified PayVault provider doesn't support direct purchases.
        /// </summary>
        DirectPurchaseNotSupportedByProvider = 52,
        
        /// <summary>
        /// The specified PayVault provider doesn't support buying coins.
        /// </summary>
        ...
        /// <summary>
        /// The item does not exists in the vault.
        /// </summary>
        ItemNotInVault = 56,
